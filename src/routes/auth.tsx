...
function AuthPage() {
  const [mode, setMode] ="sign-in" | "sign-up">("sign-in");
      ...
      <div className="mx-auto flex min-h-screen w-full max-w-md flex-col justify-center py-12">
        ...
        <div className="glass rounded-[2rem] p-6 shadow-[0_18px_40px_-28px_oklch(0_0_0/0.45)]">
          ...
          <Button
            ...
            disabled={busy}
            onClick={onGuest}
            className="glass mt-4 h-12 w-full rounded-full border-white/60 text-[15px] tracking-tight shadow-[0_8px_24px_-12px_oklch(0_0_0/0.35)]"
          >
            Continue as guest
          </Button>
