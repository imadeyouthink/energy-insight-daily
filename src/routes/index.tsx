...
function Chip({
  ...
  return (
    <div className="flex min-h-[62px] flex-col items-center justify-center gap-1 rounded-2xl border border-border bg-background px-3.5 py-3 text-center shadow-[var(--shadow-soft)]">
