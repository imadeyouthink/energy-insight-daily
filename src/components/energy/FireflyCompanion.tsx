...
export function fireflyStateFor(
  entry: {
    sleep: number;
    energy: number;
    stress: number;
...
function Welcome() {
  return (
    <svg {...svgProps}>
      ...
      />
      <path
        d="M60 30 C40 40 34 60 44 76 C52 88 68 90 78 80 C90 68 88 46 74 34 C70 30 64 28 60 30 Z"
        fill="#3d3a33"
      />
  ...
  return (
    <svg {...svgProps}>
      ...
      <ellipse
        ...
        fill="#f6fbf1"
        opacity="0.95"
        transform="rotate(28 73 30)"
      />
      <path
        d="M60 28 C38 38 32 60 43 76 C52 89 69 91 79 80 C92 67 90 44 75 32 C71 28 64 26 60 28 Z"
        fill="#3d3a33"
      />
  ...
  return (
    <svg {...svgProps}>
      ...
      <ellipse
        ...
        fill="#f6f3ea"
        opacity="0.8"
        transform="rotate(10 66 36)"
      />
      <path
        d="M58 34 C42 42 38 58 46 72 C53 82 66 84 74 76 C84 66 82 48 70 38 C66 34 61 32 58 34 Z"
        fill="#3d3a33"
      />
...
function Resting() {
  return (
    <svg {...svgProps}>
      ...
      <path
        d="M40 76 C36 60 46 46 62 46 C78 46 86 62 80 78 C76 88 64 92 52 88 C46 86 42 82 40 76 Z"
        fill="#3d3a33"
      />
      <circle cx="62" cy="79" r="6.5" fill="#e8695a" opacity="0.9" />
      <path
        d="M49 62 Q53 58 57 62"
        stroke="#211d18"
        strokeWidth="1.8"
        fill="none"
        strokeLinecap="round"
